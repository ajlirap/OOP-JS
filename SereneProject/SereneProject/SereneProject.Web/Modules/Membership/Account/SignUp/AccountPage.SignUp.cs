...
using SereneProject.Administration;
using SereneProject.Administration.Entities;
using SereneProject.Administration.Repositories;
using SereneProject.Common;
using Serenity;
using Serenity.Data;
...
namespace SereneProject.Membership.Pages
{
