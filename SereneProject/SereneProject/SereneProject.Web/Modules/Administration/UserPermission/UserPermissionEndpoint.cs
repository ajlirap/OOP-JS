...
using System.Data;
using System.Linq;
using MyRepository = SereneProject.Administration.Repositories.UserPermissionRepository;
using MyRow = SereneProject.Administration.Entities.UserPermissionRow;

namespace SereneProject.Administration.Endpoints
{
